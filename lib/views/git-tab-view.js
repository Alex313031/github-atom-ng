    ...
    return (
      <div className="github-Git too-many-changes">
        ...
        <div className="initialize-repo-description">
          The repository at <strong>{this.props.workingDirectoryPath}</strong> has too many changed files to display
          in {atom.branding.name}. Ensure that you have set up an appropriate <code>.gitignore</code> file.
        </div>
      </div>
    );
  }
